...
params.outdir = "./" 
params.busco_model = "/mnt/lustre/users/lrothmann/busco_modules"
...
process nanofilt {
    ...
    zcat \
    ${raw_reads} |\
    NanoFilt -l 1000 -q 20 --headcrop 10 --tailcrop 10 \
    > 'pri_filt.fastq'
    """
}
...
workflow {
    ...
    genomescope(jellyfish.out.jelly)
}
